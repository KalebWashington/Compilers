...
//IntToken//
		else if (isdigit(code[0]) || code[0] == '.')
		{
			counter++;
			vector <char> numvector;
			bool isReal = false;
			
			numvector.push_back(*list);
		...
		else if (code[0] == '\n')
		{
			...
			linecounter++;
			advance(list, 1);
			//cout << "newlineChar found with line "<< linecounter<< "\n";
			elements_delete(code, tokens, counter);
		}
